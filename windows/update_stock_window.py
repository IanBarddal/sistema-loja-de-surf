...
def update_stock_window(window):
    ...
    ok_button = Button (text="Atualizar", command=lambda:Products(id_entry, name_product_entry, price_entry, stock_entry, amount_entry, console_text, window1).update_stock())
        ...
        if selected_text not in ["Produto não encontrado."]:
            ...
            if active_entry == name_product_entry:
                ...
                if products_request:
                    ...
                    id_entry.insert(0, products_request[0][0])
